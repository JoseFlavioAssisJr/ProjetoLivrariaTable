...
public class FormCliente extends javax.swing.JFrame {
    ...
    private void btAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAtualizarActionPerformed
        /* 
        FAZER A MESMA COISA QUE NO BOTAO CADASTRAR
        1- Criar um objeto Cliente
        2- Pegar novamente o valor de cada campo e 'setar' no objeto
        
        Salvar no DAO através do método alterarCliente()        
        */
        ...
        FormPrincipal.daoCliente.alterarCliente(cliente);
        JOptionPane.showMessageDialog(null, "Cliente alterado com sucesso!","Cadastro de Cliente",JOptionPane.INFORMATION_MESSAGE);                        
        limpar();
