...
public class FormLivro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JComboBoxFornecedor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Editora Melhoramentos", "Fábrica de Letras", "Editora Cores e Palavras", "Informática Científica", "Ciência Moderna ", " " }));
        ...
        jButtonAtualizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icAtualizar.png"))); // NOI18N
        ...
        jButtonAtualizar.setMaximumSize(new java.awt.Dimension(90, 70));
        jButtonAtualizar.setPreferredSize(new java.awt.Dimension(90, 70));
        jButtonAtualizar.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jButtonAtualizar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonAtualizarActionPerformed(evt);
            }
        });
        jToolBar1.add(jButtonAtualizar);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(JComboBoxFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        tfCodigo.setText(livro.getTitulo());
        tfCodigo.setText(JComboBoxFornecedor.getSelectedItem().toString());
        tfCodigo.setText(Integer.toString(livro.getEstoque()));
        tfCodigo.setText(Float.toString(livro.getValor()));
        tfCodigo.setText(livro.getData());
        
        for (int i= 0; i<livro.JComboBoxFornecedor.getItemCount(); i++){{
                if (JComboBoxFornecedor.getItemAt(i).equals(livro.getFornecedor()))
                    JComboBoxFornecedor.setSelectedIndex();
            }
        else 
            {
                    jButtonAtualizar.setEnabled(true);
    ...
    private void jButtonAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtualizarActionPerformed
        ...
        //pegar cada informação dos campos e colocar  no objeto
